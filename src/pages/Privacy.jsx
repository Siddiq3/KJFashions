    ...
    <div className="container-page py-12">
      <div className="max-w-3xl rounded-md border border-primary-100 bg-white p-7 shadow-sm">
        ...
        <p className="mt-5 text-sm leading-7 text-store-dark/70">
          Khwaja Textiles & readymades does not require login or store customer accounts. Cart items stay in your browser localStorage. Order details are shared only when you submit the form and continue through WhatsApp.
        </p>
